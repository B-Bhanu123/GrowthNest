...
/**
 * Externalized Spring Boot Configuration Properties for Lending & Underwriting Engine (Lending)
 */
@Configuration
@ConfigurationProperties(prefix = "fincorex.lending")
public class LendingProperties {
    ...
    private String kafkaTopic = "fincorex.events.lending.v1";
