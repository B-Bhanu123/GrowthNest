...
/**
 * Domain Audit Log Entry Entity for Lending & Underwriting Engine
 */
@Entity
@Table(name = "lending_audit_logs", schema = "lending")
public class LendingAuditLogEntity {
    ...
    public LendingAuditLogEntity() {
        this.timestamp = LocalDateTime.now();
    }

    public LendingAuditLogEntity(UUID recordId, String actionType, String performedBy, String previousStateJson, String newStateJson) {
