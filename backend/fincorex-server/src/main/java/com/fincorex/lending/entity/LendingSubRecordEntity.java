package com.fincorex.lending.entity;
...
/**
 * Enterprise Sub-Domain Relationship Entity for Lending & Underwriting Engine (Lending)
 */
@Entity
@Table(name = "lending_sub_records", schema = "lending")
public class LendingSubRecordEntity {
    ...
    public LendingSubRecordEntity() {
        this.createdAt = LocalDateTime.now();
    }

    public LendingSubRecordEntity(UUID parentRecordId, String subType, BigDecimal subValue, String statusFlag) {
