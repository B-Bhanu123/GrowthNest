package com.fincorex.expense.openapi;

import java.math.BigDecimal;
import java.util.List;

/**
 * OpenAPI 3.0 Swagger Schema Definition Model for Corporate Expense Management
 */
public class ExpenseOpenApiMetadata {

    private String apiVersion = "v1.0.0";
    private String moduleName = "EXPENSE";
    private String description = "Enterprise REST API definitions for Corporate Expense Management";
    private List<String> supportedMediaTypes = List.of("application/json", "application/xml", "application/x-protobuf");
    private boolean isDeprecated = false;

    public ExpenseOpenApiMetadata() {}
