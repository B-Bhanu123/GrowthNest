...
/**
 * Externalized Spring Boot Configuration Properties for Corporate Expense Management (Expense)
 */
@Configuration
@ConfigurationProperties(prefix = "fincorex.expense")
public class ExpenseProperties {
    ...
    private String kafkaTopic = "fincorex.events.expense.v1";
