package com.fincorex.expense.entity;
...
/**
 * Enterprise Sub-Domain Relationship Entity for Corporate Expense Management (Expense)
 */
@Entity
@Table(name = "expense_sub_records", schema = "expense")
public class ExpenseSubRecordEntity {
    ...
    public ExpenseSubRecordEntity() {
        this.createdAt = LocalDateTime.now();
    }

    public ExpenseSubRecordEntity(UUID parentRecordId, String subType, BigDecimal subValue, String statusFlag) {
