...
/**
 * Domain Audit Log Entry Entity for Corporate Expense Management
 */
@Entity
@Table(name = "expense_audit_logs", schema = "expense")
public class ExpenseAuditLogEntity {
    ...
    public ExpenseAuditLogEntity() {
        this.timestamp = LocalDateTime.now();
    }

    public ExpenseAuditLogEntity(UUID recordId, String actionType, String performedBy, String previousStateJson, String newStateJson) {
