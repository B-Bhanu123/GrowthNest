...
/**
 * Externalized Spring Boot Configuration Properties for Transaction Processing Core (Transaction)
 */
@Configuration
@ConfigurationProperties(prefix = "fincorex.transaction")
public class TransactionProperties {
    ...
    private String kafkaTopic = "fincorex.events.transaction.v1";
