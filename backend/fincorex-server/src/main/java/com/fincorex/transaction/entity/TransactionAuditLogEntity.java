...
/**
 * Domain Audit Log Entry Entity for Transaction Processing Core
 */
@Entity
@Table(name = "transaction_audit_logs", schema = "transaction")
public class TransactionAuditLogEntity {
    ...
    public TransactionAuditLogEntity(UUID recordId, String actionType, String performedBy, String previousStateJson, String newStateJson) {
