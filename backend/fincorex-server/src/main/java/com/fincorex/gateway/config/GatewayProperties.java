...
/**
 * Externalized Spring Boot Configuration Properties for API Gateway & Security Proxy (Gateway)
 */
@Configuration
@ConfigurationProperties(prefix = "fincorex.gateway")
public class GatewayProperties {
    ...
    private String kafkaTopic = "fincorex.events.gateway.v1";
