package com.fincorex.gateway.entity;
...
/**
 * Enterprise Sub-Domain Relationship Entity for API Gateway & Security Proxy (Gateway)
 */
@Entity
@Table(name = "gateway_sub_records", schema = "gateway")
public class GatewaySubRecordEntity {
    ...
    public GatewaySubRecordEntity() {
        this.createdAt = LocalDateTime.now();
    }

    public GatewaySubRecordEntity(UUID parentRecordId, String subType, BigDecimal subValue, String statusFlag) {
