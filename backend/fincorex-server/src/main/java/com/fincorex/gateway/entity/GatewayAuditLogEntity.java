...
/**
 * Domain Audit Log Entry Entity for API Gateway & Security Proxy
 */
@Entity
@Table(name = "gateway_audit_logs", schema = "gateway")
public class GatewayAuditLogEntity {
    ...
    public GatewayAuditLogEntity(UUID recordId, String actionType, String performedBy, String previousStateJson, String newStateJson) {
