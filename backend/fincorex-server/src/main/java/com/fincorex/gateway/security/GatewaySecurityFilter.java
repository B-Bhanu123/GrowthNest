package com.fincorex.gateway.security;
...
/**
 * Enterprise Spring Security Filter for API Gateway & Security Proxy (Gateway Module)
...
public class GatewaySecurityFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        if (uri.startsWith("/api/v1/gateway")) {
            log.debug("[SECURITY-FILTER] Intercepted API Gateway & Security Proxy request: {} {} at {}", method, uri, LocalDateTime.now());
            ...
            response.setHeader("X-FinCoreX-Module", "GATEWAY");
