...
/**
 * Enterprise Sub-Domain Relationship Entity for Immutable Audit Logging (Audit)
 */
@Entity
@Table(name = "audit_sub_records", schema = "audit")
public class AuditSubRecordEntity {
    ...
    public AuditSubRecordEntity() {
        this.createdAt = LocalDateTime.now();
    }

    public AuditSubRecordEntity(UUID parentRecordId, String subType, BigDecimal subValue, String statusFlag) {
