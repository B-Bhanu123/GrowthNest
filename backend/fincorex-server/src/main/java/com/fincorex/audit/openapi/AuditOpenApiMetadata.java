package com.fincorex.audit.openapi;

import java.math.BigDecimal;
import java.util.List;

/**
 * OpenAPI 3.0 Swagger Schema Definition Model for Immutable Audit Logging
 */
public class AuditOpenApiMetadata {

    private String apiVersion = "v1.0.0";
    private String moduleName = "AUDIT";
    private String description = "Enterprise REST API definitions for Immutable Audit Logging";
    private List<String> supportedMediaTypes = List.of("application/json", "application/xml", "application/x-protobuf");
    private boolean isDeprecated = false;

    public AuditOpenApiMetadata() {}
