...
/**
 * Externalized Spring Boot Configuration Properties for Immutable Audit Logging (Audit)
 */
@Configuration
@ConfigurationProperties(prefix = "fincorex.audit")
public class AuditProperties {
    ...
    private String kafkaTopic = "fincorex.events.audit.v1";
