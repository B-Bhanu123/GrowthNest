package com.fincorex.audit.entity;
...
/**
 * Domain Audit Log Entry Entity for Immutable Audit Logging
 */
@Entity
@Table(name = "audit_audit_logs", schema = "audit")
public class AuditAuditLogEntity {
    ...
    public AuditAuditLogEntity() {
        this.timestamp = LocalDateTime.now();
    }

    public AuditAuditLogEntity(UUID recordId, String actionType, String performedBy, String previousStateJson, String newStateJson) {
