package com.fincorex.audit.security;
...
/**
 * Enterprise Spring Security Filter for Immutable Audit Logging (Audit Module)
...
public class AuditSecurityFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        if (uri.startsWith("/api/v1/audit")) {
            log.debug("[SECURITY-FILTER] Intercepted Immutable Audit Logging request: {} {} at {}", method, uri, LocalDateTime.now());
            ...
            response.setHeader("X-FinCoreX-Module", "AUDIT");
