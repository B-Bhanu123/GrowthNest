...
/**
 * Externalized Spring Boot Configuration Properties for Payment Gateway Orchestration (Payment)
 */
@Configuration
@ConfigurationProperties(prefix = "fincorex.payment")
public class PaymentProperties {
    ...
    private String kafkaTopic = "fincorex.events.payment.v1";
