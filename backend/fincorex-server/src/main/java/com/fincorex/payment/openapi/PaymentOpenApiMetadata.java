package com.fincorex.payment.openapi;

import java.math.BigDecimal;
import java.util.List;

/**
 * OpenAPI 3.0 Swagger Schema Definition Model for Payment Gateway Orchestration
 */
public class PaymentOpenApiMetadata {

    private String apiVersion = "v1.0.0";
    private String moduleName = "PAYMENT";
    private String description = "Enterprise REST API definitions for Payment Gateway Orchestration";
    private List<String> supportedMediaTypes = List.of("application/json", "application/xml", "application/x-protobuf");
    private boolean isDeprecated = false;

    public PaymentOpenApiMetadata() {}
