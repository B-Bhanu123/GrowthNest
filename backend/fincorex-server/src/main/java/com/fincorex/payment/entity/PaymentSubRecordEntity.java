package com.fincorex.payment.entity;
...
/**
 * Enterprise Sub-Domain Relationship Entity for Payment Gateway Orchestration (Payment)
 */
@Entity
@Table(name = "payment_sub_records", schema = "payment")
public class PaymentSubRecordEntity {
    ...
    public PaymentSubRecordEntity() {
        this.createdAt = LocalDateTime.now();
    }

    public PaymentSubRecordEntity(UUID parentRecordId, String subType, BigDecimal subValue, String statusFlag) {
