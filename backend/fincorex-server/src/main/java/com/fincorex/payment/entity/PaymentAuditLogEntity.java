...
/**
 * Domain Audit Log Entry Entity for Payment Gateway Orchestration
 */
@Entity
@Table(name = "payment_audit_logs", schema = "payment")
public class PaymentAuditLogEntity {
    ...
    public PaymentAuditLogEntity(UUID recordId, String actionType, String performedBy, String previousStateJson, String newStateJson) {
