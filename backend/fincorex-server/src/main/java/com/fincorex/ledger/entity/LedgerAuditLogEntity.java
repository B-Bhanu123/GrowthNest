...
/**
 * Domain Audit Log Entry Entity for Double-Entry Financial Ledger
 */
@Entity
@Table(name = "ledger_audit_logs", schema = "ledger")
public class LedgerAuditLogEntity {
    ...
    public LedgerAuditLogEntity(UUID recordId, String actionType, String performedBy, String previousStateJson, String newStateJson) {
