...
/**
 * Enterprise Sub-Domain Relationship Entity for Double-Entry Financial Ledger (Ledger)
 */
@Entity
@Table(name = "ledger_sub_records", schema = "ledger")
public class LedgerSubRecordEntity {
    ...
    public LedgerSubRecordEntity() {
        this.createdAt = LocalDateTime.now();
    }

    public LedgerSubRecordEntity(UUID parentRecordId, String subType, BigDecimal subValue, String statusFlag) {
