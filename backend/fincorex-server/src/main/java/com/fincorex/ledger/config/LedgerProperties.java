...
/**
 * Externalized Spring Boot Configuration Properties for Double-Entry Financial Ledger (Ledger)
 */
@Configuration
@ConfigurationProperties(prefix = "fincorex.ledger")
public class LedgerProperties {
    ...
    private String kafkaTopic = "fincorex.events.ledger.v1";
