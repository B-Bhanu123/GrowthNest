...
/**
 * Enterprise Sub-Domain Relationship Entity for Credit Scoring System (Credit)
 */
@Entity
@Table(name = "credit_sub_records", schema = "credit")
public class CreditSubRecordEntity {
    ...
    public CreditSubRecordEntity() {
        this.createdAt = LocalDateTime.now();
    }

    public CreditSubRecordEntity(UUID parentRecordId, String subType, BigDecimal subValue, String statusFlag) {
