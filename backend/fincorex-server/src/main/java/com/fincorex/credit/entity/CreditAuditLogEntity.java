package com.fincorex.credit.entity;
...
/**
 * Domain Audit Log Entry Entity for Credit Scoring System
 */
@Entity
@Table(name = "credit_audit_logs", schema = "credit")
public class CreditAuditLogEntity {
    ...
    public CreditAuditLogEntity() {
        this.timestamp = LocalDateTime.now();
    }

    public CreditAuditLogEntity(UUID recordId, String actionType, String performedBy, String previousStateJson, String newStateJson) {
