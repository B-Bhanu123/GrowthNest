package com.fincorex.credit.openapi;

import java.math.BigDecimal;
import java.util.List;

/**
 * OpenAPI 3.0 Swagger Schema Definition Model for Credit Scoring System
 */
public class CreditOpenApiMetadata {

    private String apiVersion = "v1.0.0";
    private String moduleName = "CREDIT";
    private String description = "Enterprise REST API definitions for Credit Scoring System";
    private List<String> supportedMediaTypes = List.of("application/json", "application/xml", "application/x-protobuf");
    private boolean isDeprecated = false;

    public CreditOpenApiMetadata() {}
