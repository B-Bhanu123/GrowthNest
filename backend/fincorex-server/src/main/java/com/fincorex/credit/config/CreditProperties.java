...
/**
 * Externalized Spring Boot Configuration Properties for Credit Scoring System (Credit)
 */
@Configuration
@ConfigurationProperties(prefix = "fincorex.credit")
public class CreditProperties {
    ...
    private String kafkaTopic = "fincorex.events.credit.v1";
