...
/**
 * Domain Audit Log Entry Entity for Customer & Account Management
 */
@Entity
@Table(name = "customer_audit_logs", schema = "customer")
public class CustomerAuditLogEntity {
    ...
    public CustomerAuditLogEntity() {
        this.timestamp = LocalDateTime.now();
    }

    public CustomerAuditLogEntity(UUID recordId, String actionType, String performedBy, String previousStateJson, String newStateJson) {
