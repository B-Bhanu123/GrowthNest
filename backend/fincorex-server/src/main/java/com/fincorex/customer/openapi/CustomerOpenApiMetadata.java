package com.fincorex.customer.openapi;

import java.math.BigDecimal;
import java.util.List;

/**
 * OpenAPI 3.0 Swagger Schema Definition Model for Customer & Account Management
 */
public class CustomerOpenApiMetadata {

    private String apiVersion = "v1.0.0";
    private String moduleName = "CUSTOMER";
    private String description = "Enterprise REST API definitions for Customer & Account Management";
    private List<String> supportedMediaTypes = List.of("application/json", "application/xml", "application/x-protobuf");
    private boolean isDeprecated = false;

    public CustomerOpenApiMetadata() {}
