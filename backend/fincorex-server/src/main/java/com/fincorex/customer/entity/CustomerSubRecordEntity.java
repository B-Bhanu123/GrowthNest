package com.fincorex.customer.entity;
...
/**
 * Enterprise Sub-Domain Relationship Entity for Customer & Account Management (Customer)
 */
@Entity
@Table(name = "customer_sub_records", schema = "customer")
public class CustomerSubRecordEntity {
    ...
    public CustomerSubRecordEntity() {
        this.createdAt = LocalDateTime.now();
    }

    public CustomerSubRecordEntity(UUID parentRecordId, String subType, BigDecimal subValue, String statusFlag) {
