...
/**
 * Externalized Spring Boot Configuration Properties for Customer & Account Management (Customer)
 */
@Configuration
@ConfigurationProperties(prefix = "fincorex.customer")
public class CustomerProperties {
    ...
    private String kafkaTopic = "fincorex.events.customer.v1";
