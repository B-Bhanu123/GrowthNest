package com.fincorex.investment.openapi;

import java.math.BigDecimal;
import java.util.List;

/**
 * OpenAPI 3.0 Swagger Schema Definition Model for Investment & Portfolio Platform
 */
public class InvestmentOpenApiMetadata {

    private String apiVersion = "v1.0.0";
    private String moduleName = "INVESTMENT";
    private String description = "Enterprise REST API definitions for Investment & Portfolio Platform";
    private List<String> supportedMediaTypes = List.of("application/json", "application/xml", "application/x-protobuf");
    private boolean isDeprecated = false;

    public InvestmentOpenApiMetadata() {}
