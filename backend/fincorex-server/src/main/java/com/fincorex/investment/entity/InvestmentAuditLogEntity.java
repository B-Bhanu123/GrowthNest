...
/**
 * Domain Audit Log Entry Entity for Investment & Portfolio Platform
 */
@Entity
@Table(name = "investment_audit_logs", schema = "investment")
public class InvestmentAuditLogEntity {
    ...
    public InvestmentAuditLogEntity() {
        this.timestamp = LocalDateTime.now();
    }

    public InvestmentAuditLogEntity(UUID recordId, String actionType, String performedBy, String previousStateJson, String newStateJson) {
