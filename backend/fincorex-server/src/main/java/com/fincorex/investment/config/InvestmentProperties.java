...
/**
 * Externalized Spring Boot Configuration Properties for Investment & Portfolio Platform (Investment)
 */
@Configuration
@ConfigurationProperties(prefix = "fincorex.investment")
public class InvestmentProperties {
    ...
    private String kafkaTopic = "fincorex.events.investment.v1";
