package com.fincorex.investment.entity;
...
/**
 * Enterprise Sub-Domain Relationship Entity for Investment & Portfolio Platform (Investment)
 */
@Entity
@Table(name = "investment_sub_records", schema = "investment")
public class InvestmentSubRecordEntity {
    ...
    public InvestmentSubRecordEntity() {
        this.createdAt = LocalDateTime.now();
    }

    public InvestmentSubRecordEntity(UUID parentRecordId, String subType, BigDecimal subValue, String statusFlag) {
