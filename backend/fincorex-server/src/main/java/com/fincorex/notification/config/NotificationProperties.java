...
/**
 * Externalized Spring Boot Configuration Properties for Centralized Notification System (Notification)
 */
@Configuration
@ConfigurationProperties(prefix = "fincorex.notification")
public class NotificationProperties {
    ...
    private String kafkaTopic = "fincorex.events.notification.v1";
