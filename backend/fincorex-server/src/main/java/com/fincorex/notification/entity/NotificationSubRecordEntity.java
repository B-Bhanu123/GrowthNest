package com.fincorex.notification.entity;
...
/**
 * Enterprise Sub-Domain Relationship Entity for Centralized Notification System (Notification)
 */
@Entity
@Table(name = "notification_sub_records", schema = "notification")
public class NotificationSubRecordEntity {
    ...
    public NotificationSubRecordEntity() {
        this.createdAt = LocalDateTime.now();
    }

    public NotificationSubRecordEntity(UUID parentRecordId, String subType, BigDecimal subValue, String statusFlag) {
