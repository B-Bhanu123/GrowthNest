...
/**
 * Domain Audit Log Entry Entity for Centralized Notification System
 */
@Entity
@Table(name = "notification_audit_logs", schema = "notification")
public class NotificationAuditLogEntity {
    ...
    public NotificationAuditLogEntity() {
        this.timestamp = LocalDateTime.now();
    }

    public NotificationAuditLogEntity(UUID recordId, String actionType, String performedBy, String previousStateJson, String newStateJson) {
