package com.fincorex.notification.openapi;

import java.math.BigDecimal;
import java.util.List;

/**
 * OpenAPI 3.0 Swagger Schema Definition Model for Centralized Notification System
 */
public class NotificationOpenApiMetadata {

    private String apiVersion = "v1.0.0";
    private String moduleName = "NOTIFICATION";
    private String description = "Enterprise REST API definitions for Centralized Notification System";
    private List<String> supportedMediaTypes = List.of("application/json", "application/xml", "application/x-protobuf");
    private boolean isDeprecated = false;

    public NotificationOpenApiMetadata() {}
