package com.fincorex.identity.openapi;

import java.math.BigDecimal;
import java.util.List;

/**
 * OpenAPI 3.0 Swagger Schema Definition Model for Identity & Access Management
 */
public class IdentityOpenApiMetadata {

    private String apiVersion = "v1.0.0";
    private String moduleName = "IDENTITY";
    private String description = "Enterprise REST API definitions for Identity & Access Management";
    private List<String> supportedMediaTypes = List.of("application/json", "application/xml", "application/x-protobuf");
    private boolean isDeprecated = false;

    public IdentityOpenApiMetadata() {}
