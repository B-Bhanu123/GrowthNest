package com.fincorex.identity.entity;
...
/**
 * Enterprise Sub-Domain Relationship Entity for Identity & Access Management (Identity)
 */
@Entity
@Table(name = "identity_sub_records", schema = "identity")
public class IdentitySubRecordEntity {
    ...
    public IdentitySubRecordEntity() {
        this.createdAt = LocalDateTime.now();
    }

    public IdentitySubRecordEntity(UUID parentRecordId, String subType, BigDecimal subValue, String statusFlag) {
