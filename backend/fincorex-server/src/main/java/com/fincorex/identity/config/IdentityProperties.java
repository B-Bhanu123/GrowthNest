...
/**
 * Externalized Spring Boot Configuration Properties for Identity & Access Management (Identity)
 */
@Configuration
@ConfigurationProperties(prefix = "fincorex.identity")
public class IdentityProperties {
    ...
    private String kafkaTopic = "fincorex.events.identity.v1";
