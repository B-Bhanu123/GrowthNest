...
/**
 * Domain Audit Log Entry Entity for Identity & Access Management
 */
@Entity
@Table(name = "identity_audit_logs", schema = "identity")
public class IdentityAuditLogEntity {
    ...
    public IdentityAuditLogEntity() {
        this.timestamp = LocalDateTime.now();
    }

    public IdentityAuditLogEntity(UUID recordId, String actionType, String performedBy, String previousStateJson, String newStateJson) {
