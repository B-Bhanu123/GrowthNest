package com.fincorex.fraud.entity;
...
/**
 * Enterprise Sub-Domain Relationship Entity for Real-Time Fraud Detection Engine (Fraud)
 */
@Entity
@Table(name = "fraud_sub_records", schema = "fraud")
public class FraudSubRecordEntity {
    ...
    public FraudSubRecordEntity() {
        this.createdAt = LocalDateTime.now();
    }

    public FraudSubRecordEntity(UUID parentRecordId, String subType, BigDecimal subValue, String statusFlag) {
