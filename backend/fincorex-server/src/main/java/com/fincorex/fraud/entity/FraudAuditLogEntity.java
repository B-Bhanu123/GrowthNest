...
/**
 * Domain Audit Log Entry Entity for Real-Time Fraud Detection Engine
 */
@Entity
@Table(name = "fraud_audit_logs", schema = "fraud")
public class FraudAuditLogEntity {
    ...
    public FraudAuditLogEntity(UUID recordId, String actionType, String performedBy, String previousStateJson, String newStateJson) {
