package com.fincorex.fraud.dto;
...
/**
 * Enterprise Create Request DTO for Fraud Domain
 */
public class CreateFraudRequest {
    ...
    public CreateFraudRequest() {}

    public CreateFraudRequest(String referenceCode, UUID ownerId, BigDecimal amount, String currency) {
