...
/**
 * Domain Audit Log Entry Entity for Automated Bank Reconciliation
 */
@Entity
@Table(name = "reconciliation_audit_logs", schema = "reconciliation")
public class ReconciliationAuditLogEntity {
    ...
    public ReconciliationAuditLogEntity() {
        this.timestamp = LocalDateTime.now();
    }

    public ReconciliationAuditLogEntity(UUID recordId, String actionType, String performedBy, String previousStateJson, String newStateJson) {
