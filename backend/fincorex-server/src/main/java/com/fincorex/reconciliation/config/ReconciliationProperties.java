...
/**
 * Externalized Spring Boot Configuration Properties for Automated Bank Reconciliation (Reconciliation)
 */
@Configuration
@ConfigurationProperties(prefix = "fincorex.reconciliation")
public class ReconciliationProperties {
    ...
    private String kafkaTopic = "fincorex.events.reconciliation.v1";
