package com.fincorex.accounting.openapi;

import java.math.BigDecimal;
import java.util.List;

/**
 * OpenAPI 3.0 Swagger Schema Definition Model for General Accounting & Trial Balance
 */
public class AccountingOpenApiMetadata {

    private String apiVersion = "v1.0.0";
    private String moduleName = "ACCOUNTING";
    private String description = "Enterprise REST API definitions for General Accounting & Trial Balance";
    private List<String> supportedMediaTypes = List.of("application/json", "application/xml", "application/x-protobuf");
    private boolean isDeprecated = false;

    public AccountingOpenApiMetadata() {}
