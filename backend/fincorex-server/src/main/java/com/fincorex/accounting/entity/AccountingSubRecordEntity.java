package com.fincorex.accounting.entity;
...
/**
 * Enterprise Sub-Domain Relationship Entity for General Accounting & Trial Balance (Accounting)
 */
@Entity
@Table(name = "accounting_sub_records", schema = "accounting")
public class AccountingSubRecordEntity {
    ...
    public AccountingSubRecordEntity() {
        this.createdAt = LocalDateTime.now();
    }

    public AccountingSubRecordEntity(UUID parentRecordId, String subType, BigDecimal subValue, String statusFlag) {
