...
/**
 * Externalized Spring Boot Configuration Properties for General Accounting & Trial Balance (Accounting)
 */
@Configuration
@ConfigurationProperties(prefix = "fincorex.accounting")
public class AccountingProperties {
    ...
    private String kafkaTopic = "fincorex.events.accounting.v1";
