...
/**
 * Domain Audit Log Entry Entity for General Accounting & Trial Balance
 */
@Entity
@Table(name = "accounting_audit_logs", schema = "accounting")
public class AccountingAuditLogEntity {
    ...
    public AccountingAuditLogEntity() {
        this.timestamp = LocalDateTime.now();
    }

    public AccountingAuditLogEntity(UUID recordId, String actionType, String performedBy, String previousStateJson, String newStateJson) {
