package com.fincorex.admin.entity;
...
/**
 * Enterprise Sub-Domain Relationship Entity for Admin & Operations Center (Admin)
 */
@Entity
@Table(name = "admin_sub_records", schema = "admin")
public class AdminSubRecordEntity {
    ...
    public AdminSubRecordEntity() {
        this.createdAt = LocalDateTime.now();
    }

    public AdminSubRecordEntity(UUID parentRecordId, String subType, BigDecimal subValue, String statusFlag) {
