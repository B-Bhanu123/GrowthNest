package com.fincorex.admin.openapi;

import java.math.BigDecimal;
import java.util.List;

/**
 * OpenAPI 3.0 Swagger Schema Definition Model for Admin & Operations Center
 */
public class AdminOpenApiMetadata {

    private String apiVersion = "v1.0.0";
    private String moduleName = "ADMIN";
    private String description = "Enterprise REST API definitions for Admin & Operations Center";
    private List<String> supportedMediaTypes = List.of("application/json", "application/xml", "application/x-protobuf");
    private boolean isDeprecated = false;

    public AdminOpenApiMetadata() {}
