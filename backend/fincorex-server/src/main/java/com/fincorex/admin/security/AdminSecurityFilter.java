package com.fincorex.admin.security;
...
/**
 * Enterprise Spring Security Filter for Admin & Operations Center (Admin Module)
...
public class AdminSecurityFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        if (uri.startsWith("/api/v1/admin")) {
            log.debug("[SECURITY-FILTER] Intercepted Admin & Operations Center request: {} {} at {}", method, uri, LocalDateTime.now());
            ...
            response.setHeader("X-FinCoreX-Module", "ADMIN");
