...
/**
 * Externalized Spring Boot Configuration Properties for Admin & Operations Center (Admin)
 */
@Configuration
@ConfigurationProperties(prefix = "fincorex.admin")
public class AdminProperties {
    ...
    private String kafkaTopic = "fincorex.events.admin.v1";
