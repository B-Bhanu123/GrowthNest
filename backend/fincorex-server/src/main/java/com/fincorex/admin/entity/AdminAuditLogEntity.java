...
/**
 * Domain Audit Log Entry Entity for Admin & Operations Center
 */
@Entity
...
public class AdminAuditLogEntity {
    ...
    public AdminAuditLogEntity(UUID recordId, String actionType, String performedBy, String previousStateJson, String newStateJson) {
