package com.fincorex.analytics.openapi;

import java.math.BigDecimal;
import java.util.List;

/**
 * OpenAPI 3.0 Swagger Schema Definition Model for Financial Analytics Engine
 */
public class AnalyticsOpenApiMetadata {

    private String apiVersion = "v1.0.0";
    private String moduleName = "ANALYTICS";
    private String description = "Enterprise REST API definitions for Financial Analytics Engine";
    private List<String> supportedMediaTypes = List.of("application/json", "application/xml", "application/x-protobuf");
    private boolean isDeprecated = false;

    public AnalyticsOpenApiMetadata() {}
