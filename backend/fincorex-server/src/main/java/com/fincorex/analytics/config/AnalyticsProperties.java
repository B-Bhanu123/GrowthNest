...
/**
 * Externalized Spring Boot Configuration Properties for Financial Analytics Engine (Analytics)
 */
@Configuration
@ConfigurationProperties(prefix = "fincorex.analytics")
public class AnalyticsProperties {
    ...
    private String kafkaTopic = "fincorex.events.analytics.v1";
