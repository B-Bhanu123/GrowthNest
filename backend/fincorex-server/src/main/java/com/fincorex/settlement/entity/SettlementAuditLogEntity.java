...
/**
 * Domain Audit Log Entry Entity for Merchant Batch Settlement
 */
@Entity
@Table(name = "settlement_audit_logs", schema = "settlement")
public class SettlementAuditLogEntity {
    ...
    public SettlementAuditLogEntity() {
        this.timestamp = LocalDateTime.now();
    }

    public SettlementAuditLogEntity(UUID recordId, String actionType, String performedBy, String previousStateJson, String newStateJson) {
