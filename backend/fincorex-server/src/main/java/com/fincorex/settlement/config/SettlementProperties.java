...
/**
 * Externalized Spring Boot Configuration Properties for Merchant Batch Settlement (Settlement)
 */
@Configuration
@ConfigurationProperties(prefix = "fincorex.settlement")
public class SettlementProperties {
    ...
    private String kafkaTopic = "fincorex.events.settlement.v1";
