package com.fincorex.settlement.openapi;

import java.math.BigDecimal;
import java.util.List;

/**
 * OpenAPI 3.0 Swagger Schema Definition Model for Merchant Batch Settlement
 */
public class SettlementOpenApiMetadata {

    private String apiVersion = "v1.0.0";
    private String moduleName = "SETTLEMENT";
    private String description = "Enterprise REST API definitions for Merchant Batch Settlement";
    private List<String> supportedMediaTypes = List.of("application/json", "application/xml", "application/x-protobuf");
    private boolean isDeprecated = false;

    public SettlementOpenApiMetadata() {}
