package com.fincorex.settlement.entity;
...
/**
 * Enterprise Sub-Domain Relationship Entity for Merchant Batch Settlement (Settlement)
 */
@Entity
@Table(name = "settlement_sub_records", schema = "settlement")
public class SettlementSubRecordEntity {
    ...
    public SettlementSubRecordEntity() {
        this.createdAt = LocalDateTime.now();
    }

    public SettlementSubRecordEntity(UUID parentRecordId, String subType, BigDecimal subValue, String statusFlag) {
