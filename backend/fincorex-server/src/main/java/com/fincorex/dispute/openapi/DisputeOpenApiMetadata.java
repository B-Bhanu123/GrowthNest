package com.fincorex.dispute.openapi;

import java.math.BigDecimal;
import java.util.List;

/**
 * OpenAPI 3.0 Swagger Schema Definition Model for Dispute & Chargeback Handling
 */
public class DisputeOpenApiMetadata {

    private String apiVersion = "v1.0.0";
    private String moduleName = "DISPUTE";
    private String description = "Enterprise REST API definitions for Dispute & Chargeback Handling";
    private List<String> supportedMediaTypes = List.of("application/json", "application/xml", "application/x-protobuf");
    private boolean isDeprecated = false;

    public DisputeOpenApiMetadata() {}
