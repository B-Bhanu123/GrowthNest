...
/**
 * Enterprise Sub-Domain Relationship Entity for Dispute & Chargeback Handling (Dispute)
 */
@Entity
@Table(name = "dispute_sub_records", schema = "dispute")
public class DisputeSubRecordEntity {
    ...
    public DisputeSubRecordEntity() {
        this.createdAt = LocalDateTime.now();
    }

    public DisputeSubRecordEntity(UUID parentRecordId, String subType, BigDecimal subValue, String statusFlag) {
