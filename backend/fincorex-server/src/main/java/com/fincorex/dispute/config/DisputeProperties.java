...
/**
 * Externalized Spring Boot Configuration Properties for Dispute & Chargeback Handling (Dispute)
 */
@Configuration
@ConfigurationProperties(prefix = "fincorex.dispute")
public class DisputeProperties {
    ...
    private String kafkaTopic = "fincorex.events.dispute.v1";
