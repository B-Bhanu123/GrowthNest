...
/**
 * Externalized Spring Boot Configuration Properties for Refund Management (Refund)
 */
@Configuration
@ConfigurationProperties(prefix = "fincorex.refund")
public class RefundProperties {
    ...
    private String kafkaTopic = "fincorex.events.refund.v1";
