...
/**
 * Enterprise Sub-Domain Relationship Entity for Refund Management (Refund)
 */
@Entity
@Table(name = "refund_sub_records", schema = "refund")
public class RefundSubRecordEntity {
    ...
    public RefundSubRecordEntity() {
        this.createdAt = LocalDateTime.now();
    }

    public RefundSubRecordEntity(UUID parentRecordId, String subType, BigDecimal subValue, String statusFlag) {
