package com.fincorex.upi.openapi;

import java.math.BigDecimal;
import java.util.List;

/**
 * OpenAPI 3.0 Swagger Schema Definition Model for UPI Instant Transfer Network
 */
public class UpiOpenApiMetadata {

    private String apiVersion = "v1.0.0";
    private String moduleName = "UPI";
    private String description = "Enterprise REST API definitions for UPI Instant Transfer Network";
    private List<String> supportedMediaTypes = List.of("application/json", "application/xml", "application/x-protobuf");
    private boolean isDeprecated = false;

    public UpiOpenApiMetadata() {}
