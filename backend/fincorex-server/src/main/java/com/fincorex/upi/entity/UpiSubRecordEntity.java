...
/**
 * Enterprise Sub-Domain Relationship Entity for UPI Instant Transfer Network (Upi)
 */
@Entity
@Table(name = "upi_sub_records", schema = "upi")
public class UpiSubRecordEntity {
    ...
    public UpiSubRecordEntity() {
        this.createdAt = LocalDateTime.now();
    }

    public UpiSubRecordEntity(UUID parentRecordId, String subType, BigDecimal subValue, String statusFlag) {
