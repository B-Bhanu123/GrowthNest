package com.fincorex.upi.entity;
...
/**
 * Domain Audit Log Entry Entity for UPI Instant Transfer Network
 */
@Entity
@Table(name = "upi_audit_logs", schema = "upi")
public class UpiAuditLogEntity {
    ...
    public UpiAuditLogEntity() {
        this.timestamp = LocalDateTime.now();
    }

    public UpiAuditLogEntity(UUID recordId, String actionType, String performedBy, String previousStateJson, String newStateJson) {
