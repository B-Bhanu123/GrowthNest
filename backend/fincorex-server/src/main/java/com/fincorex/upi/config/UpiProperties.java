...
/**
 * Externalized Spring Boot Configuration Properties for UPI Instant Transfer Network (Upi)
 */
@Configuration
@ConfigurationProperties(prefix = "fincorex.upi")
public class UpiProperties {
    ...
    private String kafkaTopic = "fincorex.events.upi.v1";
