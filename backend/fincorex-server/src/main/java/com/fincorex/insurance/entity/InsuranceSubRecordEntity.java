package com.fincorex.insurance.entity;
...
/**
 * Enterprise Sub-Domain Relationship Entity for Insurance Policy System (Insurance)
 */
@Entity
@Table(name = "insurance_sub_records", schema = "insurance")
public class InsuranceSubRecordEntity {
    ...
    public InsuranceSubRecordEntity() {
        this.createdAt = LocalDateTime.now();
    }

    public InsuranceSubRecordEntity(UUID parentRecordId, String subType, BigDecimal subValue, String statusFlag) {
