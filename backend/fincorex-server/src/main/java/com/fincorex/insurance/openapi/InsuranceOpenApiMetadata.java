package com.fincorex.insurance.openapi;

import java.math.BigDecimal;
import java.util.List;

/**
 * OpenAPI 3.0 Swagger Schema Definition Model for Insurance Policy System
 */
public class InsuranceOpenApiMetadata {

    private String apiVersion = "v1.0.0";
    private String moduleName = "INSURANCE";
    private String description = "Enterprise REST API definitions for Insurance Policy System";
    private List<String> supportedMediaTypes = List.of("application/json", "application/xml", "application/x-protobuf");
    private boolean isDeprecated = false;

    public InsuranceOpenApiMetadata() {}
