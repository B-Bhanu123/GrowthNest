...
/**
 * Domain Audit Log Entry Entity for Insurance Policy System
 */
@Entity
@Table(name = "insurance_audit_logs", schema = "insurance")
public class InsuranceAuditLogEntity {
    ...
    public InsuranceAuditLogEntity() {
        this.timestamp = LocalDateTime.now();
    }

    public InsuranceAuditLogEntity(UUID recordId, String actionType, String performedBy, String previousStateJson, String newStateJson) {
