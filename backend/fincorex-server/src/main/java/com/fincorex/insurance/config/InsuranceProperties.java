...
/**
 * Externalized Spring Boot Configuration Properties for Insurance Policy System (Insurance)
 */
@Configuration
@ConfigurationProperties(prefix = "fincorex.insurance")
public class InsuranceProperties {
    ...
    private String kafkaTopic = "fincorex.events.insurance.v1";
