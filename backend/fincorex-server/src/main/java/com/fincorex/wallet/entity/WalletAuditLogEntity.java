...
/**
 * Domain Audit Log Entry Entity for Stored-Value Digital Wallet
 */
@Entity
@Table(name = "wallet_audit_logs", schema = "wallet")
public class WalletAuditLogEntity {
    ...
    public WalletAuditLogEntity() {
        this.timestamp = LocalDateTime.now();
    }

    public WalletAuditLogEntity(UUID recordId, String actionType, String performedBy, String previousStateJson, String newStateJson) {
