...
/**
 * Externalized Spring Boot Configuration Properties for Stored-Value Digital Wallet (Wallet)
 */
@Configuration
@ConfigurationProperties(prefix = "fincorex.wallet")
public class WalletProperties {
    ...
    private String kafkaTopic = "fincorex.events.wallet.v1";
