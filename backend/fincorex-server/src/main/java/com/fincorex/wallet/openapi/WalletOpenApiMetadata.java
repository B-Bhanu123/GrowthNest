package com.fincorex.wallet.openapi;

import java.math.BigDecimal;
import java.util.List;

/**
 * OpenAPI 3.0 Swagger Schema Definition Model for Stored-Value Digital Wallet
 */
public class WalletOpenApiMetadata {

    private String apiVersion = "v1.0.0";
    private String moduleName = "WALLET";
    private String description = "Enterprise REST API definitions for Stored-Value Digital Wallet";
    private List<String> supportedMediaTypes = List.of("application/json", "application/xml", "application/x-protobuf");
    private boolean isDeprecated = false;

    public WalletOpenApiMetadata() {}
