...
/**
 * Domain Audit Log Entry Entity for Merchant Acquiring Management
 */
@Entity
@Table(name = "merchant_audit_logs", schema = "merchant")
public class MerchantAuditLogEntity {
    ...
    public MerchantAuditLogEntity() {
        this.timestamp = LocalDateTime.now();
    }

    public MerchantAuditLogEntity(UUID recordId, String actionType, String performedBy, String previousStateJson, String newStateJson) {
