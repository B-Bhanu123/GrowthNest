...
/**
 * Externalized Spring Boot Configuration Properties for Merchant Acquiring Management (Merchant)
 */
@Configuration
@ConfigurationProperties(prefix = "fincorex.merchant")
public class MerchantProperties {
    ...
    private String kafkaTopic = "fincorex.events.merchant.v1";
