package com.fincorex.merchant.openapi;

import java.math.BigDecimal;
import java.util.List;

/**
 * OpenAPI 3.0 Swagger Schema Definition Model for Merchant Acquiring Management
 */
public class MerchantOpenApiMetadata {

    private String apiVersion = "v1.0.0";
    private String moduleName = "MERCHANT";
    private String description = "Enterprise REST API definitions for Merchant Acquiring Management";
    private List<String> supportedMediaTypes = List.of("application/json", "application/xml", "application/x-protobuf");
    private boolean isDeprecated = false;

    public MerchantOpenApiMetadata() {}
