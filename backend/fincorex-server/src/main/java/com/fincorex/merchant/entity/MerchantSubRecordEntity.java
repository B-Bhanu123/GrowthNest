package com.fincorex.merchant.entity;
...
/**
 * Enterprise Sub-Domain Relationship Entity for Merchant Acquiring Management (Merchant)
 */
@Entity
@Table(name = "merchant_sub_records", schema = "merchant")
public class MerchantSubRecordEntity {
    ...
    public MerchantSubRecordEntity() {
        this.createdAt = LocalDateTime.now();
    }

    public MerchantSubRecordEntity(UUID parentRecordId, String subType, BigDecimal subValue, String statusFlag) {
