...
import com.fincorex.lending.dto.LendingSearchCriteria;
...
public class LendingTelemetryUnitTest {

    @Test
    @DisplayName("Verify Lending & Underwriting Engine SearchCriteria default paging and sorting parameters")
    ...
    @Test
    @DisplayName("Verify Lending & Underwriting Engine SearchCriteria range filters")
