...
public class AnalyticsSubRecordUnitTest {

    @Test
    @DisplayName("Verify sub-record entity fields and defaults for Financial Analytics Engine")
    void testSubRecordEntityCreation() {
        UUID parentId = UUID.randomUUID();
        AnalyticsSubRecordEntity sub = new AnalyticsSubRecordEntity(parentId, "AUDIT_DETAILS", new BigDecimal("150.25"), "PROCESSED");
