...
import com.fincorex.expense.dto.ExpenseSearchCriteria;
...
public class ExpenseTelemetryUnitTest {

    @Test
    @DisplayName("Verify Corporate Expense Management SearchCriteria default paging and sorting parameters")
    ...
    @Test
    @DisplayName("Verify Corporate Expense Management SearchCriteria range filters")
