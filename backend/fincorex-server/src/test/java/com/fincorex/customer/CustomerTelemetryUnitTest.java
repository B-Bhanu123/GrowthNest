...
import com.fincorex.customer.dto.CustomerSearchCriteria;
...
public class CustomerTelemetryUnitTest {

    @Test
    @DisplayName("Verify Customer & Account Management SearchCriteria default paging and sorting parameters")
    ...
    @Test
    @DisplayName("Verify Customer & Account Management SearchCriteria range filters")
