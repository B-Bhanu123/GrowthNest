...
public class InsuranceSubRecordUnitTest {

    @Test
    @DisplayName("Verify sub-record entity fields and defaults for Insurance Policy System")
    void testSubRecordEntityCreation() {
        UUID parentId = UUID.randomUUID();
        InsuranceSubRecordEntity sub = new InsuranceSubRecordEntity(parentId, "AUDIT_DETAILS", new BigDecimal("150.25"), "PROCESSED");
