...
public class CreditSubRecordUnitTest {

    @Test
    @DisplayName("Verify sub-record entity fields and defaults for Credit Scoring System")
    void testSubRecordEntityCreation() {
        UUID parentId = UUID.randomUUID();
        CreditSubRecordEntity sub = new CreditSubRecordEntity(parentId, "AUDIT_DETAILS", new BigDecimal("150.25"), "PROCESSED");
