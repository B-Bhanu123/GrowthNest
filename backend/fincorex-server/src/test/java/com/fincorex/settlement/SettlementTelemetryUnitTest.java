...
import com.fincorex.settlement.dto.SettlementSearchCriteria;
...
public class SettlementTelemetryUnitTest {

    @Test
    @DisplayName("Verify Merchant Batch Settlement SearchCriteria default paging and sorting parameters")
    void testSearchCriteriaDefaults() {
        SettlementSearchCriteria criteria = new SettlementSearchCriteria();
    ...
    @Test
    @DisplayName("Verify Merchant Batch Settlement SearchCriteria range filters")
