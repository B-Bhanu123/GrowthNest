...
public class SettlementServiceUnitTest {
    ...
    private SettlementRecordEntity entity;
    private UUID ownerId;

    @BeforeEach
    void setUp() {
        ownerId = UUID.randomUUID();
        entity = new SettlementRecordEntity("REF-10029", ownerId, new BigDecimal("450.00"), "ACTIVE");
        entity.setId(UUID.randomUUID());
    }

    @Test
    void testCreateRecordSuccess() {
        when(repository.save(any(SettlementRecordEntity.class))).thenReturn(entity);

        SettlementDTO result = service.createRecord("REF-10029", ownerId, new BigDecimal("450.00"), "ACTIVE");
    ...
    void testGetByReferenceCodeSuccess() {
        ...
        SettlementDTO result = service.getByReferenceCode("REF-10029");
