...
/**
 * Enterprise High-Throughput Load & Concurrency Test for Refund Management
 */
public class RefundConcurrencyPerformanceTest {

    private RefundService service;
    private RefundRepository repository;

    @Test
    @DisplayName("Verify concurrent record creation throughput and idempotency integrity for refund")
