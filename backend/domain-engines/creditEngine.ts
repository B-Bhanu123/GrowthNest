...
export class CreditDomainEngine {
  private validationRules: CreditValidationRule[] = [];
  private eventLog: CreditDomainEvent[] = [];
  ...
  public emitEvent(eventType: string, payload: Record<string, any>): CreditDomainEvent {
  ...
  public getEventHistory(): CreditDomainEvent[] {
...
export const creditEngineInstance = new CreditDomainEngine();
