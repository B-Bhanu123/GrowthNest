...
export interface UpiValidationRule {
  ruleId: string;
  ruleName: string;
...
export class UpiDomainEngine {
  private validationRules: UpiValidationRule[] = [];
  private eventLog: UpiDomainEvent[] = [];
  ...
  public emitEvent(eventType: string, payload: Record<string, any>): UpiDomainEvent {
    const event: UpiDomainEvent = {
  ...
  public getEventHistory(): UpiDomainEvent[] {
...
export const upiEngineInstance = new UpiDomainEngine();
