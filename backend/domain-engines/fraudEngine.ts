...
export interface FraudValidationRule {
  ruleId: string;
  ruleName: string;
...
export class FraudDomainEngine {
  private validationRules: FraudValidationRule[] = [];
  private eventLog: FraudDomainEvent[] = [];
  ...
  public emitEvent(eventType: string, payload: Record<string, any>): FraudDomainEvent {
    const event: FraudDomainEvent = {
  ...
  public getEventHistory(): FraudDomainEvent[] {
...
export const fraudEngineInstance = new FraudDomainEngine();
