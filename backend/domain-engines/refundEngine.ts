...
export interface RefundValidationRule {
  ruleId: string;
  ruleName: string;
...
export class RefundDomainEngine {
  private validationRules: RefundValidationRule[] = [];
  private eventLog: RefundDomainEvent[] = [];
  ...
  public emitEvent(eventType: string, payload: Record<string, any>): RefundDomainEvent {
    const event: RefundDomainEvent = {
  ...
  public getEventHistory(): RefundDomainEvent[] {
...
export const refundEngineInstance = new RefundDomainEngine();
