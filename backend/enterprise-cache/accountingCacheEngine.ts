/**
 * FinCoreX Enterprise L1 Caching Engine: General Accounting & Trial Balance (accounting)
 */

export class AccountingEnterpriseCacheEngine {
...
export const accountingCacheEngineInstance = new AccountingEnterpriseCacheEngine();
