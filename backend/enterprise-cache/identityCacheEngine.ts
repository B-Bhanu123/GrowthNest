/**
 * FinCoreX Enterprise L1 Caching Engine: Identity & Access Management (identity)
 */

export class IdentityEnterpriseCacheEngine {
...
export const identityCacheEngineInstance = new IdentityEnterpriseCacheEngine();
