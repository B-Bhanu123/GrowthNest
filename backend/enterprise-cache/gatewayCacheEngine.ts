/**
 * FinCoreX Enterprise L1 Caching Engine: API Gateway & Security Proxy (gateway)
 */

export class GatewayEnterpriseCacheEngine {
...
export const gatewayCacheEngineInstance = new GatewayEnterpriseCacheEngine();
