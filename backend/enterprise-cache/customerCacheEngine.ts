/**
 * FinCoreX Enterprise L1 Caching Engine: Customer & Account Management (customer)
 */

export class CustomerEnterpriseCacheEngine {
...
export const customerCacheEngineInstance = new CustomerEnterpriseCacheEngine();
