/**
 * FinCoreX Enterprise L1 Caching Engine: Merchant Acquiring Management (merchant)
 */

export class MerchantEnterpriseCacheEngine {
...
export const merchantCacheEngineInstance = new MerchantEnterpriseCacheEngine();
