/**
 * FinCoreX Enterprise L1 Caching Engine: Corporate Expense Management (expense)
 */

export class ExpenseEnterpriseCacheEngine {
...
export const expenseCacheEngineInstance = new ExpenseEnterpriseCacheEngine();
