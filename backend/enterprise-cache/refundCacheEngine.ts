/**
 * FinCoreX Enterprise L1 Caching Engine: Refund Management (refund)
 */

export class RefundEnterpriseCacheEngine {
...
export const refundCacheEngineInstance = new RefundEnterpriseCacheEngine();
