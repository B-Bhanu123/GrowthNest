/**
 * FinCoreX Enterprise L1 Caching Engine: Merchant Batch Settlement (settlement)
 */

export class SettlementEnterpriseCacheEngine {
...
export const settlementCacheEngineInstance = new SettlementEnterpriseCacheEngine();
