/**
 * FinCoreX Enterprise L1 Caching Engine: Stored-Value Digital Wallet (wallet)
 */

export class WalletEnterpriseCacheEngine {
...
export const walletCacheEngineInstance = new WalletEnterpriseCacheEngine();
